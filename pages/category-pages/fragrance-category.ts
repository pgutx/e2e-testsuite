...
export class CategoryFragrance{
    readonly page: Page;
    ...
    constructor(page:Page){
      this.page = page;
      this.menLink = page.locator('#maincontainer').getByRole('link', { name: 'Men', exact: true });
      this.womenLink = page.getByRole('link', { name: 'Women', exact: true });
      ...
      this.itemName = page.getByTitle('ck one shock for him Deodorant');
      ...
      this.itemPrice = page.getByText('$14.00').first();
