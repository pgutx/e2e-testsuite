...
export class CategorySkincare{
    readonly page: Page;
    readonly eyesLink: Locator;
    readonly faceLink: Locator;
    readonly giftLink: Locator;
    readonly nailsLink: Locator;
    readonly sunLink: Locator;
    ...
    constructor(page:Page){
      ...
      this.giftLink = page.getByRole('link', { name: 'Gift Ideas & Sets', exact: true });
      this.nailsLink = page.getByRole('link', { name: 'Hands & Nails', exact: true });
      this.sunLink = page.getByRole('link', { name: 'Sun', exact: true });
      ...
      this.itemName = page.getByTitle('Total Moisture Facial Cream');
      this.itemImage = page.locator('div.col-md-3:nth-child(6) > div:nth-child(2) > a:nth-child(1) > img:nth-child(1)');
      this.itemViewButton = page.getByRole('link', { name: 'View', exact: true });
      this.itemReviewButton = page.getByRole('link', { name: 'Write Review' });
      this.itemPrice = page.getByText('$38.00').first();
      this.itemCartButton = page.getByRole('link', { name: '' }).nth(2);
    }
